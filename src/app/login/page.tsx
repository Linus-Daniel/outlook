...
export default function Login() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    console.log(formData ," Sent Datas");
    ...
    <>
      ...
      <main className="relative min-h-screen flex-col w-full overflow-hidden items-center px-2 flex md:items-center md:justify-center bg-white">
        ...
        <div className="flex-col flex w-full max-w-md">
            ...
            >
              ...
              <div className="w-full md:w-1/2  py-4 sm:p-10">
                ...
                <input
                  ...
                  className={`w-full border-b border-[#1b1b1b] text-sm py-1 ${
              ...
              <div className="w-full md:w-1/2 py-4 sm:p-10">
                ...
                <p className="text-sm text-gray-600 mb-6">
                  No account?{" "}
                  <a href="#" className="text-[#0067b8] text-xs hover:underline">
                    Forgot password
                  </a>
                </p>
                <button onClick={handleSubmit} className="bg-[#0067b8] absolute w-[108px] h-[32px] text-sm right-4 md:right-4 bottom-3 flex items-center justify-center text-white py-2 transition">
                  Sign in
                </button>
              </div>
            </div>
          ...
          {/* Sign-in Options */}
          <div className={`border ${step === 2 ? "hidden" : "block"} z-50 bg-white w-full max-w-md px-6 flex items-center py-2 mx-auto mt-10 md:mt-4 h-12`}>
